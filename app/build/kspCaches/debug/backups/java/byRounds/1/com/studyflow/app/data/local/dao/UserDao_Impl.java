  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserEntity = new EntityInsertionAdapter<UserEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `users` (`userId`,`name`,`email`,`language`,`themePref`,`xpPoints`) VALUES (?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(5, entity.getThemePref());
    ...
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<UserEntity>() {
      ...
      public UserEntity call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfThemePref = CursorUtil.getColumnIndexOrThrow(_cursor, "themePref");
          ...
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpThemePref;
            _tmpThemePref = _cursor.getString(_cursorIndexOfThemePref);
            final int _tmpXpPoints;
            _tmpXpPoints = _cursor.getInt(_cursorIndexOfXpPoints);
            _result = new UserEntity(_tmpUserId,_tmpName,_tmpEmail,_tmpLanguage,_tmpThemePref,_tmpXpPoints);
          } else {
            _result = null;
          }
          return _result;
